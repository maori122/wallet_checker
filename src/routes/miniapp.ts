    ...
    <script>
      ...
      const L10N = {
        ru: {
          ...
          bonusPercent: "Сколько процентов добавить к сроку в днях при активации (не от суммы оплаты). Пример: 20 — к дням прибавляется 20% от их числа",
        ...
        en: {
          ...
          bonusPercent: "How many percent to add to the day count on activation (not from payment). Example: 20 adds 20% of those days on top",
